...
export const gameRequirements = sqliteTable(
  "game_requirements",
  {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    gameId: text("game_id")
...
export const reports = sqliteTable(
  "reports",
  {
    ...
    createdAt: text("created_at").default(sql`(datetime('now'))`),
    lastViewed: text("last_viewed").default(sql`(datetime('now'))`),
  },
  (table) => [
...
export const popularSearches = sqliteTable(
  "popular_searches",
  {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    gameId: text("game_id")
    ...
    lastSearchedAt: text("last_searched_at").default(sql`(datetime('now'))`),
  },
  (table) => [
